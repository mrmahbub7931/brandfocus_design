	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'tm_marketing' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'tm_marketing' ); ?></th>
			</tr>
		</thead>
		<tbody>
